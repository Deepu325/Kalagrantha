...
import './CreativeHubNavbar.scss';

const CreativeHubNavbar = () => {
    const { activeVertical } = useNav();
    const [isMegaMenuOpen, setIsMegaMenuOpen] = useState(false);

    return (
        <nav className="creative-hub-nav">
            <div className="nav-container">
                <div className="nav-left">
                    <Link to="/home" className="logo">
                        <span className="logo-text">KALA</span>
                        <span className="logo-sub">CREATIVE</span>
                    </Link>
                </div>
...
export default CreativeHubNavbar;